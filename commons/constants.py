...
CALLBACK_SHARE_PREFIX = "share."
CALLBACK_SHARE_YES = f"{CALLBACK_SHARE_PREFIX}yes"
CALLBACK_SHARE_NO = f"{CALLBACK_SHARE_PREFIX}no"
MSG_START = (
...
KEY_IS_SHARED = "is_shared"
KEY_USER_SHARE = "user_share"
